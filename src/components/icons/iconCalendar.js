export default class HeroIconCalendar extends HTMLElement {
...
if (!customElements.get("heroicon-calendar")) {
	customElements.define("heroicon-calendar", HeroIconCalendar);
}
