...
export default class HeroIconClipboard extends HTMLElement {
...
if (!customElements.get("heroicon-clipboard")) {
	customElements.define("heroicon-clipboard", HeroIconClipboard);
}
